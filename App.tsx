...
type Screen = 'title' | 'story' | 'daily' | 'settings' | 'gallery' | 'credits';

const SCREENS: Screen[] = ['title', 'story', 'daily', 'settings', 'gallery', 'credits'];
...
function Root() {
  ...
  if (screen === 'settings') return <SettingsScreen onBack={back} onCredits={() => setScreen('credits')} />;
