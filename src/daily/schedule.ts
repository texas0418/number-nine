...
//
// AUTHORING CONSTRAINT (B4 crossover, tested in test-cipher.ts): every line
// must carry at least TWO distinct words of >=5 letters — the crossover
// card asks "what did I say tonight" and re-deals with a different true
// word each time; a one-word line would pin the answer.
...
export const TRANSMISSIONS: string[] = [
  ...
  "I CAN HEAR IT PLAINLY IN THE OTHER ROOM",
